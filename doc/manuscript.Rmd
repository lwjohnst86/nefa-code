...
fig_gee <- fig('gee', 'Longitudinal associations of individual NEFA (mol% and nmol/mL) with insulin sensitivity and beta-cell function over the 6 years in the PROMISE cohort. Fully adjusted generalized estimating equation models, adjusting for time, WC, sex, ethnicity, baseline age, ALT, and family history of diabetes. X-axis values represent a percent difference in the outcome per SD increase in the fatty acid. P-values were adjusted for the BH false discovery rate, with the {{largest dot}} representing a significant (p<0.05) association.')
```
