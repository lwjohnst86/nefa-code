...
non-esterified fatty acids (NEFA) on changes in insulin sensitivity and
...
years in this analysis of the PROMISE cohort (n=`r percent.change.outcomes$n`).
...
(see `r cite_sf('gee')`), particularly for the concentration compared to the
mol% data. Full model adjustment (`r cite_f('gee')`) attenuated most of these
...
specific fatty acids in the NEFA fraction strongly predicted lower beta-cell
